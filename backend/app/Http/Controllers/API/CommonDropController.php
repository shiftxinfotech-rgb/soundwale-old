...
class CommonDropController extends Controller {
    ...
    public function home_header_slider_list(Request $request) {
        ...
        $data = HomeSlider::where('status', 1)->select('id', 'image', 'status')->orderBy('id', 'desc')->get();
        if ($data->isEmpty()) {
    ...
    public function home_footer_slider_list(Request $request) {
        ...
        $data = HomeFooterSlider::where('status', 1)->select('id', 'image', 'status')->orderBy('id', 'desc')->get();
        if ($data->isEmpty()) {
            return response()->json(['status' => false, 'message' => 'Details not found.'], 404);
        }
    ...
    public function faq_list(Request $request) {
        ...
        $data = Faq::select('id', 'title', 'description')->orderBy('id', 'desc')->get();
        if ($data->isEmpty()) {
            return response()->json(['status' => false, 'message' => 'Details not found.'], 404);
        }
    ...
    public function parts_lists(Request $request) {
        ...
        if ($request->filled('user_id')) {
            $data = Parts::where('status', 1)->orWhere('user_id', $request->user_id)->orderBy('name', 'asc')->select('id', 'name', 'status')->get();
        } else {
            $data = Parts::where('status', 1)->orderBy('name', 'asc')->select('id', 'name', 'status')->get();
        }
        if ($data->isEmpty()) {
            return response()->json(['status' => false, 'message' => 'Details not found.'], 404);
        }
    ...
    public function manufacturer_lists(Request $request) {
        ...
        if ($request->filled('user_id')) {
            $data = Manufacturer::where('status', 1)->orWhere('user_id', $request->user_id)->orderBy('name', 'asc')->select('id', 'name', 'status')->get();
        } else {
            $data = Manufacturer::where('status', 1)->orderBy('name', 'asc')->select('id', 'name', 'status')->get();
        }
        if ($data->isEmpty()) {
            return response()->json(['status' => false, 'message' => 'Details not found.'], 404);
        }
    ...
    public function model_lists(Request $request) {
        ...
        if ($request->filled('user_id')) {
            $data = $data = Models::where('status', 1)->orWhere('user_id', $request->user_id)->orderBy('name', 'asc')->select('id', 'name', 'status')->get();
        } else {
    ...
    public function sub_category_lists(Request $request) {
        ...
        if ($request->filled('category_id')) {
            $categoryIds = collect(explode(',', $request->category_id))->filter()->all();
            if ($request->filled('user_id')) {
                $data = SubCategory::where('status', 1)->whereIn('category_id', $categoryIds)->orWhere('user_id', $request->user_id)->orderBy('name', 'asc')->select('id', 'category_id', 'name', 'status')->get();
            } else {
                $data = SubCategory::where('status', 1)->whereIn('category_id', $categoryIds)->orderBy('name', 'asc')->select('id', 'category_id', 'name', 'status')->get();
            }
        } else {
...
//        $countries = Country::with('states')->get();
	...
	public function get_filter_data(Request $request) {
        ...
        if ($type == "buyer") {
            ...
            if ($request->user_id) {
                $data['main_category'] = Categories::where('status', 1)->orWhere('user_id', $request->user_id)->orderBy('name', 'asc')->select('id', 'name', 'image', 'status')->get();
                $data['category'] = Category::where('status', 1)->orWhere('user_id', $request->user_id)->orderBy('name', 'asc')->select('id', 'name', 'status')->get();
                $data['sub_category'] = SubCategory::where('status', 1)->orWhere('user_id', $request->user_id)->orderBy('name', 'asc')->select('id', 'category_id', 'name', 'status')->get();
                $data['model'] = Models::where('status', 1)->orWhere('user_id', $request->user_id)->orderBy('name', 'asc')->select('id', 'name', 'status')->get();
            } else {
                $data['main_category'] = Categories::where('status', 1)->orderBy('name', 'asc')->select('id', 'name', 'image', 'status')->get();
                $data['category'] = Category::where('status', 1)->orderBy('name', 'asc')->select('id', 'name', 'status')->get();
                $data['sub_category'] = SubCategory::where('status', 1)->orderBy('name', 'asc')->select('id', 'category_id', 'name', 'status')->get();
                $data['model'] = Models::where('status', 1)->orderBy('name', 'asc')->select('id', 'name', 'status')->get();
            }
            return response()->json(['status' => true, 'data' => $data], 200);
        } else {
        ...
        $data['requirement_type'] = Requirment::where('status', 1)->orderBy('name', 'asc')->select('id', 'name', 'status')->get();
    ...
    public function get_filter_data_old(Request $request) {
