...
//        SellerDetails::raw('AVG(review.rating) as average_rating'),
        ...
        $query = SellerDetails::select('register.role_id', 'business.establishment_year', 'business.establishment_year', SellerDetails::raw("
            CASE 
...
//                    'state_id.required' => 'The state field is required.',
        ...
        try {
            $data = $request->only('role_id', 'product_id', 'user_id', 'country_id', 'other_details', 'state_id', 'city_id', 'requirment_id', 'categories_id', 'category_id', 'sub_category_id', 'price', 'description', 'image', 'status');
    ...
    public function get_related_post(Request $request) {
        ...
        try {
            $limit = $request->limit;
            $query = SellerDetails::select('register.role_id', 'business.establishment_year', 'business.establishment_year', SellerDetails::raw("IF(seller_details_likes.status = 1, 1, 0) as is_likes"), 'seller_details.id', 'seller_details.view_counter', 'seller_details.other_details', 'seller_details.user_id', SellerDetails::raw("
            CASE 
                WHEN register.image IS NOT NULL AND register.image != '' 
                THEN CONCAT('https://developerwork.in/soundwale/public/storage/app/register/', register.image)
                ELSE CONCAT('https://developerwork.in/soundwale/public/admin-asset/images/profile_default_image.png') 
    ...
    public function post_by_user_id(Request $request) {
        ...
        try {
            ...
            $query = SellerDetails::select('register.role_id', 'business.establishment_year', 'business.establishment_year', SellerDetails::raw("IF(seller_details_likes.status = 1, 1, 0) as is_likes"), 'seller_details.id','seller_details.product_id','seller_details.role_id as roles_id', 'seller_details.view_counter', 'seller_details.other_details', 'seller_details.user_id', SellerDetails::raw("
            CASE 
                WHEN register.image IS NOT NULL AND register.image != '' 
                THEN CONCAT('https://developerwork.in/soundwale/public/storage/app/register/', register.image)
                ELSE CONCAT('https://developerwork.in/soundwale/public/admin-asset/images/profile_default_image.png') 
    ...
    public function get_by_id(Request $request) {
        ...
        "),SellerDetails::raw("
            CASE 
                ...
                THEN CONCAT('https://developerwork.in/soundwale/public/storage/app/categories/', categories.image)
                ELSE CONCAT('https://developerwork.in/soundwale/public/admin-asset/images/200x200.png') 
