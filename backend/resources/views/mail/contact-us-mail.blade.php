    ...
    <div>
        <section
            ...
            <div>
                ...
                <p
                    style="font-size: 16px; font-weight: 500; line-height: 27px; text-align: left; color: rgba(0, 0, 0, 1)">
                    We received your message through our Contact Us form. Below are the details you provided:</p>
                ...
                <ul style="margin: 0; padding: 0 0 0 20px">
                    ...
                    <li
                        ...
                        <strong>Subject :</strong><span
                            style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px; text-align:justify">
                            {{ $usersMailData['to_subject'] }}</span>
                    </li>
                    <li
                        style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px">
                        <strong>Message :</strong><br><br><span
                            style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px; text-align:justify">
                            {{ $usersMailData['to_message'] }}</span>
                    </li>
                </ul>
                <p></p>
                ...
                <p
                    style="font-size: 16px; font-weight: 500; line-height: 27px; text-align: left; color: rgba(0, 0, 0, 1)">
                    Thank you for reaching out to us! Our team will review your inquiry and get back to you soon.<br>
                    {{ config('app.name') }}
                </p>
            </div>
            <hr style="border: none; border-top: 1px solid #dddddd; margin: 20px 0;">
