    ...
    <div>
        <section
            ...
            <div>
                <ul style="margin: 0; padding: 0; text-align: center">
                    <li style="list-style-type: none; display: inline-block; margin-right: 10px">
                        <img src="{{ asset('admin-asset/images/logo.png') }}"
                            alt="{{ config('app.name') }}">
                    </li>
            ...
            <div>
                ...
                <p>We received your application through our Hiring Talent. Below are the details you provided:</p>
                <p></p>
                ...
                <ul style="margin: 0; padding: 0 0 0 20px">
                    ...
                    <li
                        ...
                        <strong>Designation :</strong> <span
                            style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px; text-align:justify">
                            {{ $usersMailData['designation'] }}</span>
                    </li>
                    <li
                        style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px">
                        <strong>Company Name :</strong> <span
                            style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px; text-align:justify">
                            {{ $usersMailData['company_name'] }}</span>
                    </li>
                    <li
                        style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px">
                    ...
                    <li
                        ...
                        <strong>Work Email :</strong><span
                            style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px; text-align:justify">
                          <a href="mailto:{{ $usersMailData['to_email'] }}">{{ $usersMailData['to_email'] }}</a> </span>
                    </li>
                    <li
                        style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px">
                        <strong>Skype :</strong><span
                            style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px; text-align:justify">
                           {{ $usersMailData['skype'] }}</span>
                    </li>
                    <li
                        style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px">
                        <strong>Company Website :</strong><span
                            style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px; text-align:justify">
                           {{ $usersMailData['company_website'] }}</span>
                    </li>
                    <li
                        style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px">
                        <strong>City :</strong><span
                            style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px; text-align:justify">
                           {{ $usersMailData['city'] }}</span>
                    </li>
                    <li
                        style="font-size: 12px; font-weight: 400; line-height: 12px; text-align: left; color: rgba(90, 104, 114, 1); margin-bottom: 16px">
            ...
            <div>
                <ul style="margin: 0; padding: 0; text-align: center">
                    <li style="list-style-type: none; display: inline-block; margin-right: 10px">
                        <img src="{{ asset('admin-asset/images/favicon.ico') }}"
                            alt="{{ config('app.name') }}" style="height: 24px; width: 24px">
                    </li>
                </ul>
            </div>
            <div>
