    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <a href="{{ route('admin.teams.list') }}" class="kt-subheader__breadcrumbs-link" title="Back">List</a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__head kt-portlet__head--lg">
                ...
                <h3 class="kt-portlet__head-title">
                    {{ $data ? 'Edit' : 'Add' }} Meet The Team
                </h3>
                </div>
            </div>
            <!--begin::Portlet-->
            <!--begin::Form-->
            <form class="kt-form" action="{{ route('admin.teams.store') }}" id="amenities-add-from" method="post"
                isReload="{{ route('admin.teams.list') }}" enctype="multipart/form-data">
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        ...
                        {{-- <div class="form-group col-lg-6">
                            ...
                            <textarea name="message" placeholder="Enter Description" class="form-control">{{ $data->message ?? null }}</textarea>
                        </div> --}}
    ...
    <script type="text/javascript">
        let conf = {
            rules: {
                ...
                image_2: {
                    required: {{ $data && $data->image_2 ? 'false' : true }},
                },
                // country_code: {
                //     required: true,
                // },
