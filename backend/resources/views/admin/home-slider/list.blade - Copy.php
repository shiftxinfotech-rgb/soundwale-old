    ...
    <script>
        let conf = {
            columns: [
                ...
                //                 '<label>'+
                //                     '<input type="checkbox" class="home-slider-status-switch" '+checked+'  value="1" data-id="'+row.id+'">'+
                //                     '<span></span>'+
                //                 '</label>'+
                //             '</span>'
                //     }
        ...
        makeDataTable('#home_slider_list_table', "{{ route('admin.home.slider.list') }}", conf);

        function updateStatus(newStatus, checkbox, recordId) {
            var checkbox = checkbox;
            $.ajax({
                url: "{{ route('admin.home.slider.status.change') }}",
                type: 'POST',
                data: {
                    id: recordId,
                    status: newStatus
