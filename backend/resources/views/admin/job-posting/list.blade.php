                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        ...
                        <div class="dropdown dropdown-inline">
                            <a href="{{ route('admin.job.posting.add') }}" class="btn btn-brand btn-icon-sm">
...
@push('script')
    <script>
        ...
        makeDataTable('#amenities_list_table', "{{ route('admin.job.posting.list') }}", conf);


        function updateStatus(newStatus, checkbox, recordId) {
            var checkbox = checkbox;
            $.ajax({
                url: "{{ route('admin.job.posting.status.change') }}",
                type: 'POST',
                data: {
                    id: recordId,
                    status: newStatus
