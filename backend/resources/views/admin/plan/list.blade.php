...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
    ...
    <div class="kt-portlet kt-portlet--mobile">
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                    ...
                    <div class="kt-portlet__head-actions">
                        &nbsp;
                        <a href="{{ route('admin.plans.add') }}" class="btn btn-brand btn-elevate btn-icon-sm" id="add-service-form-modal">
        ...
        <div class="kt-portlet__body">
            <!--begin: Datatable -->
            <table class="table table-striped table-hover" id="plan_list_table">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th>Actions</th>
...
@push('script')
    <script>
        ...
        makeDataTable('#plan_list_table', "{{ route('admin.plans.list') }}", conf);

        function updateStatus(newStatus,checkbox,recordId) {
            var checkbox = checkbox;
            $.ajax({
                url : "{{ route('admin.plans.status.change') }}",
                type : 'POST',
