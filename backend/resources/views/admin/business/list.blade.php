    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        ...
                        <div class="dropdown dropdown-inline">
                            <a href="{{ route('admin.business.add') }}" class="btn btn-brand btn-icon-sm">
            ...
            <div class="kt-portlet__body">
                <!--begin: Datatable -->
                <table class="table table-striped table-hover" id="business_list_table">
                    <thead>
                        <tr>
                            <th>User Name</th>
                            <th>Image</th>
...
@push('script')
    <script>
        ...
        makeDataTable('#business_list_table', "{{ route('admin.business.list') }}", conf);

        function updateStatus(newStatus, checkbox, recordId) {
            var checkbox = checkbox;
            $.ajax({
                url: "{{ route('admin.business.status.change') }}",
                type: 'POST',
                data: {
                    id: recordId,
                    status: newStatus
