...
@section('content')
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Shorts</h3>
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <!--begin: Datatable -->
                <table class="table table-striped table-hover" id="advertisement_list_table">
                    <thead>
                        <tr>
                            <th>Username</th>
                            <th>Video</th>
...
//                            autoplay muted loop playsinline
                            return '<video width="160" height="90"><source src="' + row.video_url + '" type="video/mp4">Your browser does not support the video tag.</video>';
                        } else {
                            return "<source src='" + row.video_url + "' type=\"video/mp4\"><source src='" + row.video_url + "' type=\"video/ogg\">";
                        }
                    }
                },{
                    data: 'description',
        ...
        makeDataTable('#advertisement_list_table', "{{ route('admin.shorts.list') }}", conf);

        function updateStatus(newStatus, checkbox, recordId) {
            var checkbox = checkbox;
            $.ajax({
                url: "{{ route('admin.shorts.status.change') }}",
                type: 'POST',
                data: {
                    id: recordId,
                    status: newStatus
