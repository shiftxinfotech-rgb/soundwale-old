    ...
    <script>
        let conf = {
            columns: [{
                ...
                {
                    data: 'look_who_s_trending',
                    name: 'look_who_s_trending'
                },
                {
                    data: 'our_top_pick',
                    name: 'our_top_pick'
        ...
        makeDataTable('#amenities_list_table', "{{ route('admin.categories.list') }}", conf);

        function updateStatus(newStatus, checkbox, recordId) {
            var checkbox = checkbox;
            $.ajax({
                url: "{{ route('admin.categories.status.change') }}",
                type: 'POST',
                data: {
                    id: recordId,
                    status: newStatus
