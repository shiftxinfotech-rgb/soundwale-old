                                ...
                                <div class="kt-widget__body">
                                    <div class="kt-widget__content">
                                        <div class="kt-widget__info">
                                            ...
                                            <a href="mailto:{{ $user->email }}" class="kt-widget__data"> {{ $user->email }} </a>
                                        </div>
                                        <div class="kt-widget__info">
                                            <span class="kt-widget__label">Phone :</span>
                                            <a href="tel:{{ $user->phone }}" class="kt-widget__data">{{ $user->phone }}</a>
                                        </div>
                                    </div>
                                    <div class="kt-widget__items">

                                        <a href="{{ route('admin.profile.edit') }}" class="kt-widget__item ">
                        ...
                        <div class="col-xl-12">
                            <div class="kt-portlet kt-portlet--height-fluid">
                                ...
                                <form class="kt-form kt-form--label-right"
                                    action="{{ route('admin.profile.change.password.update') }}"
                                    enctype="multipart/form-data" isReload="{{ route('admin.profile.change.password') }}"
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="input-group">
                                                            <input type="password" name="current_password"
                                                                class="form-control pwd-hide-show" id="current_password"
                                                ...
                                                <!-- New Password -->
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">New Password <span
                                                        class="text-danger">*</span></label>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="input-group">
                                                            <input type="password" name="new_password"
                                                                class="form-control pwd-hide-show" id="new_password"
                                                ...
                                                <div class="form-group form-group-last row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Confirm Password  <span
                                                        class="text-danger">*</span></label>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="input-group">
                                                            <input type="password" name="password_confirmation"
                                                                class="form-control pwd-hide-show"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            let conf = {
                rules: {
                    current_password: {
                        required: true,
                        // minlength: 8,
                        // pattern: "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&])[A-Za-z\\d@$!%*?&]{8,}$" // escape special characters
                ...
                messages: {
                    new_password: {
                        pattern: "The password must be at least 8 characters long and contain at least one uppercase letter, one lowercase letter, one number, and one symbol."
                    }
                },
                errorElement: "div",
            ...
            $(".show-hide").click(function() {
                let input = $(this).closest('.input-group').find('.pwd-hide-show');
