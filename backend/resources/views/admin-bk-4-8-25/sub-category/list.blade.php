                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            &nbsp;
                            <a href="{{ route('admin.sub.category.add') }}" class="btn btn-brand btn-elevate btn-icon-sm"
...
<script>
        ...
        makeDataTable('#amenities_list_table', "{{ route('admin.sub.category.list') }}", conf);
    </script>
    <script>
        function updateStatus(newStatus, checkbox, recordId) {
            var checkbox = checkbox;
            $.ajax({
                url: "{{ route('admin.sub.category.status.change') }}",
                type: 'POST',
                data: {
                    id: recordId,
                    status: newStatus
