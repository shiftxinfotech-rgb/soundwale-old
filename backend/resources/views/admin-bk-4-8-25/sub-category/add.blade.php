...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-subheader__main">
        <h3 class="kt-subheader__title">Sub Category</h3>
        <span class="kt-subheader__separator kt-hidden"></span>
        <div class="kt-subheader__breadcrumbs">
            <span class="kt-subheader__breadcrumbs-separator"></span>
            <a href="{{ route('admin.sub.category.list') }}" class="kt-subheader__breadcrumbs-link" title="Back">List</a>
            <span class="kt-subheader__breadcrumbs-separator"></span>
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    {{ $data ? 'Edit' : 'Add New' }} Sub Category
                </h3>
            </div>
        </div>
        <!--begin::Portlet-->
        <!--begin::Form-->
        <form class="kt-form" action="{{ route('admin.sub.category.store') }}" id="amenities-add-from" method="post"
              isReload="{{ route('admin.sub.category.list') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <select id="category_id" name="category_id" class="form-control">
                            ...
                            <option value="{{ $category->id }}"
                                    @if(isset($data) && $data->category_id == $category->id) selected @endif>
                                    {{ $category->name }}
                        </option>
                        @endforeach
                    </select>
