...
@section('content')
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Delete Account Request</h3>
...
@push('script')
    <script>
        ...
        makeDataTable('#advertisement_list_table', "{{ route('admin.delete_account_request.list') }}", conf);

        function updateStatus(newStatus, checkbox, recordId) {
            var checkbox = checkbox;
            $.ajax({
                url: "{{ route('admin.delete_account_request.status.change') }}",
                type: 'POST',
                data: {
                    id: recordId,
                    status: newStatus
