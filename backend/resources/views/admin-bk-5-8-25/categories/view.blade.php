                    ...
                    <div class="kt-widget kt-widget--user-profile-3">
                        <div class="kt-widget__top">
                            ...
                            <div class="kt-widget__content">
                                ...
                                <div class="kt-widget__head">
                                    <span>
                                        @if(isset($data) && $data->look_who_s_trending == 1) Look Who's Trending : Yes @else Look Who's Trending : No @endif
                                    </span>
                                </div>
                                <div class="kt-widget__head">
                                    <span>
                                        @if(isset($data) && $data->our_top_pick == 1) Our Top Pick : Yes @else Our Top Pick : No @endif
                                    </span>
                                </div>
                            </div>
                        </div>
