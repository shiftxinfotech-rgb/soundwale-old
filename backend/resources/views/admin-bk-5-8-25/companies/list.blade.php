...
@section('content')
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Companies</h3>
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            &nbsp;
                            <a href="{{ route('admin.companies.add') }}" class="btn btn-brand btn-elevate btn-icon-sm"
...
@push('script')
    <script>
        ...
        makeDataTable('#amenities_list_table', "{{ route('admin.companies.list') }}", conf);

        function updateStatus(newStatus, checkbox, recordId) {
            var checkbox = checkbox;
            $.ajax({
                url: "{{ route('admin.companies.status.change') }}",
                type: 'POST',
                data: {
                    id: recordId,
                    status: newStatus
