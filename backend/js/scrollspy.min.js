!(function (t, e) {
    t.fn.extend({
        scrollspy: function (n) {
            var a = { namespace: "scrollspy", activeClass: "active", animate: !1, offset: 0, container: e };
            n = t.extend({}, a, n);
            var o = function (t, e) {
                ...
                for (var a = this, i = t(n.container), l = t(a).find("a"), c = 0; c < l.length; c++) {
                    ...
                    t(h).on("click", function (a) {
                        ...
                        if (f.length > 0) {
                            ...
                            n.animate ? t("html, body").animate({ scrollTop: s }, 1e3) : e.scrollTo(0, s), a.preventDefault();
                        }
                    });
                }
                var v = r(l);
